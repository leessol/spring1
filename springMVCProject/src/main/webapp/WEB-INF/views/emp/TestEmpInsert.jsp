...
<body>
	...
	<img alt="" src="${path}/images/umbrella.jpg" width="30%">
	<form method="post"
		...
		<table>
			...
			<tr class="form-floating">
				...
				<td><input class="form-control" type="number"
					...
					placeholder="직원번호는sequence처리함" autofocus="autofocus" value="999"></td>
			</tr>
			<tr>
				<td>firstName</td>
			...
			<tr>
				<td>이메일</td>
				<td><input type="email" name="email" value="wed@daum.net"
			...
			<tr>
				<td>부서</td>
				<td><input type="number" name="department_id" value="10">
				</td>
			</tr>
			<tr>
				<td>메니져</td>
